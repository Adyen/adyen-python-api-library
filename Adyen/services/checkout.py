...
class AdyenCheckoutApi(AdyenServiceBase):
    ...
    def payment_methods(self, request, **kwargs):
        ...
        return self.client.call_adyen_api(request, self.service, method, endpoint, **kwargs)

    def payments(self, request, idempotency_key=None, **kwargs):
        endpoint = "payments"
        method = "POST"
        return self.client.call_adyen_api(request, self.service, method, endpoint, idempotency_key,
                                          **kwargs)
