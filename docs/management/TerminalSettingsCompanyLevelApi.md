...
response = apiClient.terminal_settings_company_level_api.get_terminal_logo()
...
apiClient.client.xapikey = "YourApiKey"
apiClient.client.platform = "test"
response = apiClient.terminal_settings_company_level_api.get_terminal_settings()
...
response = apiClient.terminal_settings_company_level_api.update_terminal_logo(request)
...
response = apiClient.terminal_settings_company_level_api.update_terminal_settings(request)
