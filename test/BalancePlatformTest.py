...
class TestBalancePlatform(unittest.TestCase):
    ...
    def test_creating_balance_account(self):
        ...
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/configuration/balance-account-created.json"
        )
    ...
    def test_creating_account_holder(self):
        ...
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/configuration/account-holder-created.json"
        )
    ...
    def test_get_balance_platform(self):
        ...
        self.adyen.client = self.test.create_client_from_file(
            200, None, "test/mocks/configuration/balance-platform-retrieved.json"
        )
    ...
    def test_creating_payment_instrument(self):
        ...
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/configuration/business-account-created.json"
        )
        result = self.adyen.balancePlatform.payment_instruments_api.create_payment_instrument(
            request
        )
    ...
    def test_creating_transfer_limit(self):
        request = {
            ...
            "scaInformation": {"scaOnApproval": True},
        ...
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/configuration/transfer-limit-created.json"
        )
        result = self.adyen.balancePlatform.transfer_limits_balance_platform_level_api.create_transfer_limit(
            request, balance_platform_id
        )
    ...
    def test_creating_webhook(self):
        request = {
            "type": "balance",
            "target": {"type": "balanceAccount", "id": "BA00000000000000000LIABLE"},
            "currency": "USD",
            "status": "active",
            "conditions": [
                {"balanceType": "available", "conditionType": "lessThan", "value": 500000}
            ],
        }
        ...
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/configuration/webhook-setting-created.json"
        )
        result = self.adyen.balancePlatform.balances_api.create_webhook_setting(
            request, balance_platform_id, webhook_id
        )
    ...
    def test_creating_payment_instrument_group(self):
        request = {"balancePlatform": "YOUR_BALANCE_PLATFORM", "txVariant": "mc"}
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/configuration/payment-instrument-group-created.json"
        )
        result = self.adyen.balancePlatform.payment_instrument_groups_api.create_payment_instrument_group(
            request
        )
    ...
    def test_get_transaction_rule(self):
        ...
        self.adyen.client = self.test.create_client_from_file(
            200, {}, "test/mocks/configuration/transaction-rule-retrieved.json"
        )
        result = self.adyen.balancePlatform.transaction_rules_api.get_transaction_rule(
            transactionRuleId
        )
    ...
    def test_update_network_token(self):
        ...
        result = self.adyen.balancePlatform.network_tokens_api.update_network_token(
            request, "TK123ABC"
        )
