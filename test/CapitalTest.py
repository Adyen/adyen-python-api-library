...
class TestCapital(unittest.TestCase):
    ...
    def test_request_grant(self):
        ...
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/capital/grants-success.json"
        )
    ...
    def test_get_all_grant_offers(self):
        request = {}
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/capital/grant-offers-success.json"
        )
    ...
    def test_get_all_grants(self):
        ...
        result = self.adyen.capital.grants_api.get_all_grants(
            counterparty_account_holder_id="AH00000000000000000000001"
        )
        self.assertEqual(1, len(result.message["grants"]))
        self.assertEqual("GR00000000000000000000001", result.message["grants"][0]["id"])
    ...
    def test_get_grant(self):
        request = {}
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/capital/get-grant-success.json"
        )
    ...
    def test_get_all_grant_disbursements(self):
        request = {}
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/capital/get-grant-disbursements-success.json"
        )
        result = self.adyen.capital.grants_api.get_all_grant_disbursements(
    ...
    def test_get_grant_disbursement(self):
        request = {}
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/capital/get-grant-disbursement-success.json"
        )
        result = self.adyen.capital.grants_api.get_grant_disbursement(
            grantId="GR00000000000000000000001", disbursementId="DI00000000000000000000001"
        )
    ...
    def test_update_grant_disbursement(self):
        request = {}
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/capital/update-grant-disbursement-success.json"
        )
        result = self.adyen.capital.grants_api.update_grant_disbursement(
            request, grantId="GR00000000000000000000001", disbursementId="DI00000000000000000000001"
        )
    ...
    def test_get_grant_account_information(self):
        request = {}
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/capital/get-grant-account-success.json"
        )
        result = self.adyen.capital.grant_accounts_api.get_grant_account_information(
    ...
    def test_get_grant_offer(self):
        request = {}
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/capital/get-grant-offer-success.json"
        )
