...
class TestDisputes(unittest.TestCase):
    ...
    def test_accept_dispute(self):
        ...
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/disputes/post-acceptDispute-accept-dispute-200.json"
        )
    ...
    def test_defend_dispute(self):
        ...
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/disputes/post-defendDispute-defend-dispute-200.json"
        )
    ...
    def test_supply_defense_document(self):
        ...
        self.adyen.client = self.test.create_client_from_file(
            200,
            request,
            "test/mocks/disputes/post-supplyDefenseDocument-supply-defense-document-200.json",
        )
