...
class TestManagement(unittest.TestCase):
    ...
    def test_get_company_account(self):
        ...
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/management/get_company_account.json"
        )

        result = self.adyen.management.account_company_level_api.get_company_account(
    ...
    def test_my_api_credential_api(self):
        ...
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/management/post_me_allowed_origins.json"
        )
    ...
    def test_no_content(self):
        self.adyen.client = self.test.create_client_from_file(
            204, {}, "test/mocks/management/no_content.json"
        )
    ...
    def test_update_store(self):
        ...
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/management/update_a_store.json"
        )
        store_id = "YOUR_STORE_ID"
        merchant_id = "YOUR_MERCHANT_ACCOUNT_ID"

        result = self.adyen.management.account_store_level_api.update_store(
            request, merchant_id, store_id
        )
    ...
    def test_reassign_terminal(self):
        ...
        result = self.adyen.management.terminals_terminal_level_api.reassign_terminal(
            request, "AMS1-2345"
        )
    ...
    def test_create_a_user(self):
        ...
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/management/create_a_user.json"
        )
        company_id = "YOUR_COMPANY_ACCOUNT"
    ...
    def test_get_list_of_android_apps(self):
        request = {}
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/management/get_list_of_android_apps.json"
        )
        company_id = "YOUR_COMPANY_ACCOUNT"
    ...
    def test_query_parameters(self):
        request = {}
        company_id = "YOUR_COMPANY_ACCOUNT"
        query_parameters = {"pageNumber": 1, "pageSize": 10}
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/management/get_list_of_merchant_accounts.json"
        )

        self.adyen.management.account_company_level_api.list_merchant_accounts(
            company_id, query_parameters=query_parameters
        )
