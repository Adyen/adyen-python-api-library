...
class TestModifications(unittest.TestCase):
    ...
    def test_capture_success(self):
        ...
        self.ady.client = self.test.create_client_from_file(200, request,
                                                            ...
                                                            'capture-success'
                                                            '.json')
        result = self.ady.payment.modifications_api.capture_authorisation(request)
    ...
    def test_capture_error_167(self):
        ...
        self.assertRaisesRegex(
            ...
            self.ady.payment.modifications_api.capture_authorisation,
            request
        )
    ...
    def test_cancel_or_refund_received(self):
        ...
        self.ady.client = self.test.create_client_from_file(200, request,
                                                            ...
                                                            'cancelOrRefund'
                                                            '-received.json')
        result = self.ady.payment.modifications_api.cancel_or_refund_payment(request)
    ...
    def test_refund_received(self):
        ...
        self.ady.client = self.test.create_client_from_file(200, request,
                                                            ...
                                                            'refund-received'
                                                            '.json')
        result = self.ady.payment.modifications_api.refund_captured_payment(request)
    ...
    def test_cancel_received(self):
        ...
        self.ady.client = self.test.create_client_from_file(200, request,
                                                            ...
                                                            'cancel-received'
                                                            '.json')
        result = self.ady.payment.modifications_api.cancel_authorisation(request)
    ...
    def test_adjust_authorisation_received(self):
        ...
        self.ady.client = self.test.create_client_from_file(200, request,
                                                            ...
                                                            'authorisation-'
                                                            'received.json')
        result = self.ady.payment.modifications_api.change_the_authorised_amount(request)
