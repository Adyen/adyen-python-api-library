...
class TestPayments(unittest.TestCase):
    ...
    def test_authorise_error010_mocked(self):
        ...
        self.adyen.client = self.test.create_client_from_file(
            403, request, "test/mocks/authorise-error-010.json"
        )
        self.assertRaises(
            Adyen.AdyenAPIInvalidPermission, self.adyen.payment.payments_api.authorise, request
        )
    ...
    def test_authorise_error_cvc_declined_mocked(self):
        ...
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/authorise-error-cvc-declined.json"
        )
        result = self.adyen.payment.payments_api.authorise(request)
    ...
    def test_authorise_success_3d_mocked(self):
        ...
        request["browserInfo"] = {"userAgent": "YourUserAgent", "acceptHeader": "YourAcceptHeader"}
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/authorise-success-3d.json"
        )
        result = self.adyen.payment.payments_api.authorise(request)
    ...
    def test_authorise_3d_success_mocked(self):
        ...
        request["browserInfo"] = {"userAgent": "YourUserAgent", "acceptHeader": "YourAcceptHeader"}
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/authorise3d-success.json"
        )
    ...
    def test_authorise_cse_success_mocked(self):
        ...
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/authorise-success-cse.json"
        )
        result = self.adyen.payment.payments_api.authorise(request)
        self.assertEqual("Authorised", result.message["resultCode"])
    ...
    def test_authorise_cse_error_expired_mocked(self):
        ...
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/authorise-error-expired.json"
        )
        result = self.adyen.payment.payments_api.authorise(request)
        self.assertEqual("Refused", result.message["resultCode"])
        self.assertEqual(
    ...
    def test_error_401_mocked(self):
        ...
        self.adyen.client = self.test.create_client_from_file(
            401, request, "test/mocks/authorise-error-010.json"
        )
