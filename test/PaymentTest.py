...
class TestPayments(unittest.TestCase):
    ...
    def test_authorise_success_mocked(self):
        ...
        self.adyen.client = self.test.create_client_from_file(200, request,
                                                              ...
                                                              '-success'
                                                              '.json')
        result = self.adyen.payment.general_api.create_authorisation(request)
    ...
    def test_authorise_error010_mocked(self):
        ...
        self.assertRaises(Adyen.AdyenAPIInvalidPermission,
                          self.adyen.payment.general_api.create_authorisation, request)
    ...
    def test_authorise_3d_success_mocked(self):
        ...
        self.adyen.client = self.test.create_client_from_file(200, request,
                                                              ...
                                                              'authorise3d-'
                                                              'success.json')
        result = self.adyen.payment.general_api.complete3ds_authorisation(request)
        self.assertEqual("Authorised", result.message['resultCode'])
