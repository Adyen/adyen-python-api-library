...
class TestManagement(unittest.TestCase):
    ...
    def test_transfer_fund(self):
        request = {
            "amount": {"value": 110000, "currency": "EUR"},
        ...
        self.adyen.client = self.test.create_client_from_file(
            200, request, "test/mocks/transfers/make-transfer-response.json"
        )
    ...
    def test_get_all_transactions(self):
        self.adyen.client = self.test.create_client_from_file(
            200, None, "test/mocks/transfers/get-all-transactions.json"
        )
    ...
    def test_get_transaction(self):
        transacion_id = "123"
        self.adyen.client = self.test.create_client_from_file(
            200, None, "test/mocks/transfers/get-transaction.json"
        )
