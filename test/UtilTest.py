...
class UtilTest(unittest.TestCase):
    ...
    def test_notification_request_item_hmac(self):
        ...
        self.assertDictEqual(request["additionalData"], {"hmacSignature": hmac_calculation_str})
    ...
    def test_query_string_creation(self):
        query_parameters = {"pageSize": 7, "pageNumber": 3}
    ...
    def test_is_valid_hmac_notification_removes_additional_data(self):
        ...
        self.assertIsNotNone(
            notification["notificationItems"][0]["NotificationRequestItem"]["additionalData"]
        )
